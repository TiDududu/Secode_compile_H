...
*/
//@audit: It is true that ethers transfering to this contract will be locked
// however, the contract handles msg.value. 
// As an example: a contract to lock and stake ETH would allow payable but not extracting.
